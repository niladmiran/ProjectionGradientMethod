...
for size in sizes:
    ...
    result = {'iters_l1': 0, 'iters_lp': 0,
              'time_l1': 0, 'time_lp': 0,
              'obj_val_l1': 0, 'obj_val_lp': 0,
              'nonzero_l1': 0, 'nonzero_lp': 0,
              'res_l1': 0, 'res_lp': 0}
    ...
    for _ in range(num_simulations):
        ...
        result_lp = run_proj_lpball(A, x0, b, p, radius_lp, 10000, method='bisection')
